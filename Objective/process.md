...
- Full API test suite: `247 passed, 0 failed, 0 skipped`
...
- Controller ownership audit: direct EF/data access ลดลงเหลือ 3 controller files รวม 63 matches (จากเดิม 7 files / 101 matches); `TeacherEndpoints.cs` เหลือ 0
...
4. **ย้าย Direct EF ออกจาก Legacy Controllers:** จัดการ 3 ไฟล์ที่เหลือ (`User`, `Auth`, `Parent`) ให้เข้า Repository/Service Layer โดย `Institute` และ `Teacher` แยกชั้นแล้ว

...
{
    Task<IEnumerable<DTOs.ProductResponse>> GetByInstituteIdAsync(int instituteId, CancellationToken cancellationToken = default);
    Task<DTOs.ProductResponse?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
    Task<DTOs.ProductResponse> CreateAsync(int instituteId, DTOs.CreateProductRequest request, CancellationToken cancellationToken = default);

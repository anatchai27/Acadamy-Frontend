...
public interface ICourseService
{
    ...
    Task<UpdateCourseResponse> UpdateAsync(int id, UpdateCourseRequest request, int? instituteId, CancellationToken ct = default);
}
...
public class CourseService(Repositories.ICourseRepository repository) : ICourseService
{
    ...
    public async Task<Models.Course?> GetByIdAsync(int id, int? instituteId, CancellationToken ct = default)
    {
        return await _repository.GetByIdAsync(id, instituteId, ct);
    }
    ...
    public async Task<UpdateCourseResponse> UpdateAsync(int id, UpdateCourseRequest request, int? instituteId, CancellationToken ct = default)
    {
        try
        {
            var course = await _repository.UpdateAsync(id, request, instituteId, ct);

...
public interface IStudentRepository
{
    ...
    Task<Models.Student?> GetStudentCardAsync(int id, CancellationToken ct = default);
    ...
    IAsyncEnumerable<DTOs.StudentExportRow> StreamExportAsync(CancellationToken ct = default);
}

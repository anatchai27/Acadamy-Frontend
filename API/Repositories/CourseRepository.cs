...
public interface ICourseRepository
{
    ...
    Task<Course?> UpdateAsync(int id, UpdateCourseRequest request, CancellationToken ct = default);
}
...
public class CourseRepository(TutoringDbContext context) : ICourseRepository
{
    ...
    public async Task<Course?> UpdateAsync(int id, UpdateCourseRequest request, CancellationToken ct = default)
    {

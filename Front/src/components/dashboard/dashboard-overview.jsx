...
function UsersGroupIcon({ class: className }) { return <HiOutlineUsers class={className} />; }
function QrCheckIcon({ class: className }) { return <HiOutlineQrCode class={className} />; }
function ClipboardDocIcon({ class: className }) { return <HiOutlineClipboardDocumentCheck class={className} />; }
function BanknotesIcon({ class: className }) { return <HiOutlineBanknotes class={className} />; }
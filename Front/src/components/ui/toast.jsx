...
export function Toast({ id, message, type, onRemove }) {
  ...
  return (
    <div
      ...
      } ${isNeo ? 'p-4 border-2' : 'w-80 rounded-xl border shadow-sm p-4 backdrop-blur-sm'} ${cfg.wrapper[type]}`}
    >
      <div class="flex items-start gap-3">
        ...
        <button
          type="button"
          class={`bg-transparent border-none cursor-pointer p-0 transition-colors ${cfg.close}`}
          onClick={handleClose}
        >

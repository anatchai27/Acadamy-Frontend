...
const CustomInput = forwardRef(({ value, onClick, placeholder, className, label, error, showTime, isReadOnly }, ref) => (
  <div class="flex flex-col gap-1.5">
    ...
    <div class="relative">
      <input
        ...
        class={`w-full px-4 py-2.5 bg-white border rounded-xl text-sm cursor-pointer transition-all focus:outline-none focus:ring-2 focus:ring-oasis-primary/20 focus:border-oasis-primary text-zinc-800 placeholder-zinc-400 ${error ? 'border-red-400' : 'border-zinc-200'} ${isReadOnly ? '' : ''} ${className}`}
      />
